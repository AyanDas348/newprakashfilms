...
const Home1 = ({ projects, data, footerData }) => {
  ...
  const partner_images = Array.from({ length: 8 }).map((_, i) => `/assets/img/partners/partner${i + 1}.png`)
...
return (
  <LightLayout
    ...
    <Partners newProjectLayout={newProjectLayout} projects={partner_images} />
