                ...
                <div className="row">
                            ...
                            <div className="col">
                                <div className="col-sm-6">
                                    <div className="item mb-50">
                                        <h3>
                                            <span className="nbr playfont">1000 +</span>
                                        </h3>
                                        <h6>MOVIES</h6>
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div className="item mb-50">
                                        <h3>
                                            <span className="nbr playfont">5 +</span>
                                        </h3>
                                        <h6>LANGUAGES</h6>
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div className="item mb-50">
                                        <h3>
                                            <span className="nbr playfont">Across 4</span>
                                        </h3>
                                        <h6>STATES</h6>
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-6">
                        <div className="txt-cont">
                            <h6 className="sub-title" style={{ textAlign: "justify", margin: '0px 20px' }}>Our Vision</h6>
                            <p className="mb-20 mt-40" style={{ textAlign: "justify", margin: '0px 20px' }}>
                                {/* {data.content} */}
